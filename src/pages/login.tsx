...
const CreateAccountForm = () => {
    ...
    <div className="min-h-screen bg-[#FFFFFF] flex flex-col gap-24">
        ...
        <div className="flex flex-row justify-between items-center w-screen">
          <div className="bg-gray p-8 rounded-xl flex flex-col gap-6 items-center justify-center w-1/2">
            <div className='w-96'>
              ...
              <button className="w-96 bg-gradient-to-r from-lowpurple to-highpurple border border-transparent hover:border-gray-300 text-white px-9 py-3 rounded-full text-base font-medium font-semibold">
                Login
              </button>
              ...
              <div className='flex flex-row items-center gap-4'>
                <div className="border-b border-greyshade h-1 w-1/3"></div>
                <span className='text-sm font-bold text-greyshade'>or Sign in with</span>
                <div className="border-b border-greyshade h-1 w-1/3"></div>
                </div>
          ...
          <div className='w-1/2'>
            <Image className='mx-auto' src="/images/blockchain.jpg" alt="Example Image" width={500} height={300} />
            </div>
        </div>
    </div>
